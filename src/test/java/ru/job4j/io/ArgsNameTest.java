...
class ArgsNameTest {
    ...
    @Test
    void whenStringContainsNoKeyThenExceptionThrown() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"-Xmx=512", "-=msg=Hello"}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("^.+")
                .hasMessageContaining("Error: This argument '-=msg=Hello' does not contain a key");
    ...
    @Test
    void whenStringContainsNoValue() {
    ...
    @Test
    void whenStringContainsNoSpecialChar() {
    ...
    @Test
    void whenStringContainsNoSpecialChar1() {
